 ...
 * Callbacks are implemented directly on the fragments.
 * <p/>
 * SlidingTabLayout and SlidingTabStrip are from google/iosched:
 * https://github.com/google/iosched
 */
public class ViewPagerTab2Activity extends ActionBarActivity {
            ...
            switch (pattern) {
                case 0: {
                    ...
                    if (0 <= mScrollY) {
                        ...
                        args.putInt(ViewPagerTab2ScrollViewFragment.ARG_SCROLL_Y, mScrollY);
                        f.setArguments(args);
                    }
                    break;
                }
                case 1: {
                    ...
                    if (0 < mScrollY) {
                        Bundle args = new Bundle();
                        args.putInt(ViewPagerTab2ListViewFragment.ARG_INITIAL_POSITION, 1);
                        f.setArguments(args);
                    }
                    break;
                }
