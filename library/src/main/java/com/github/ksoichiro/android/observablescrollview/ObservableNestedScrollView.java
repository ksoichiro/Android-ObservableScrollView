...
public class ObservableNestedScrollView extends NestedScrollView implements Scrollable {
    ...
    static class SavedState implements Parcelable {
        ...
        // This keeps the parent(NestedScrollView)'s state
        ...
        private SavedState(Parcel in) {
            // Parcel 'in' has its parent(NestedScrollView)'s saved state.
            // To restore it, class loader that loaded NestedScrollView is required.
            Parcelable superState = in.readParcelable(NestedScrollView.class.getClassLoader());
